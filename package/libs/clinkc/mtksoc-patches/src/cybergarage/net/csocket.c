...
#endif
#if 0 // TungYu, get interface name by IP, ABUU customization
#include <ifaddrs.h>
#endif
/*
#define SOCKET_DEBUG
...
#define READBUFSIZE 2000
int cg_usual_sendfile(CgSocket *sock, int fp, ssize_t flen)
{
	ssize_t nSent, size_to_send;
	int nTotalSent = 0;
	int cmdPos = 0;
	...
	ptr = (unsigned char*)malloc(READBUFSIZE);
