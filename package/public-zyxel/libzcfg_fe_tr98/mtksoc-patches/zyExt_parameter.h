...
tr98Parameter_t para_LogCfgGpAccount[] = {
	...
	{ "SshKeyBaseAuthPublicKey", PARAMETER_ATTR_WRITE, 4097, json_type_string},
	{ NULL, 0, 0}
};
#endif
...
tr98Parameter_t para_LogSetting[] = {
	...
	{ "AT_LOG_Enable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
...
tr98Parameter_t para_Ssh[] = {
	{ "PublicKeyNumberOfEntries", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ NULL, 0, 0, 0}
};

tr98Parameter_t para_SshPubKey[] = {
	{ "Key", PARAMETER_ATTR_WRITE, 4097, json_type_string},
	{ NULL, 0, 0, 0}
};
#endif
