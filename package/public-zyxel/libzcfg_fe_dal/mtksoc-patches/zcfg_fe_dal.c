...
extern dal_param_t SMS_NOTIFICATION_param[];
#endif
#endif
...
#endif
#if BUILD_PACKAGE_ZyIMS
extern dal_param_t VOLTE_param[];
#endif
...
extern dal_param_t SCH_FQCODEL_param[];
#endif
...
#ifdef ZYXEL_SMSNOTIFICATION
extern zcfgRet_t zcfgFeDalSmsNotification(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
#endif
#endif
#ifdef ZYXEL_WEB_GUI_CELLWAN_SUPPORT_PCI_LOCK
...
#endif
#if BUILD_PACKAGE_ZyIMS
extern zcfgRet_t zcfgFeDalVolte(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
extern zcfgRet_t zcfgFeDalShowVolte(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
#endif
...
#endif
#ifdef ZYXEL_FQ_CODEL
extern zcfgRet_t zcfgFeDalSchFqCodel(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
#endif
#ifdef ZYXEL_CELLWAN_WITH_LTE_MODULE_TEMPERATURE
...
#endif
#ifdef ZYXEL_FQ_CODEL
extern void zcfgFeDalShowSchFqCodel(struct json_object *Jarray);
#endif
#ifdef ZYXEL_CELLWAN_WITH_LTE_MODULE_TEMPERATURE
...
#endif
#if BUILD_PACKAGE_ZyIMS
{"volte",			VOLTE_param,		zcfgFeDalVolte,			zcfgFeDalShowVolte,		"get|edit", "VoLTE"},//VoLTE
#endif
...
#ifdef ZYXEL_SMSNOTIFICATION
{"sms_ntfy",	SMS_NOTIFICATION_param,	zcfgFeDalSmsNotification,	NULL,					"",					""}, //temporarily GUI only
#endif
#endif
#ifdef ZYXEL_WEB_GUI_CELLWAN_SUPPORT_PCI_LOCK
...
#endif
#ifdef ZYXEL_WEB_GUI_SUPPORT_SAS_CBSD 
{"cbsd", 		CBSD_param,		zcfgFeDalCbsd,		zcfgFeDalShowCbsd,		"get|edit",				"SAS_CBSD"},
#endif
...
#endif
#ifdef ZYXEL_FQ_CODEL
{"schedule_Fqcode",    SCH_FQCODEL_param, zcfgFeDalSchFqCodel,    zcfgFeDalShowSchFqCodel, "get|edit", "Remote_MGMT"},
#endif
#ifdef ZYXEL_CELLWAN_WITH_LTE_MODULE_TEMPERATURE
