...
#if defined(PACKAGE_lte_srv_diag)||defined(PACKAGE_zyNWmonitor)
{"CELL_Network_Monitor_Enable", dalType_boolean, 0, 0, NULL},//PACKAGE_lte_srv_diag|PACKAGE_zyNWmonitor
#endif
