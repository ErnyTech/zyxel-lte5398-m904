...
#ifdef ZYXEL_PERIODIC_ONLINE_UPGRADE
		json_object_object_add(paramJobj, "FWUpdateNotify", JSON_OBJ_COPY(json_object_object_get(Obj, "FWUpdateNotify")));
#endif
#ifdef ZYXEL_WEB_GUI_SHOW_DOWNLOADING_FW_PROGRESS_BAR
		json_object_object_add(paramJobj, "FWProgress", FW_Progress_Jarray);
#endif
