...
typedef struct ZyXEL_VoiceVoLTE_st{
	bool   enable;
...
#define VOIP_IOP_FLAG_SEND_FORCED_REGISTER_WHEN_OFFHOOK_FROM_IDLE	(1 << 9) //Steve.2018.10.11: [Mobile][Q15] Send forced register when off-hook to make call
...
#ifdef ZYXEL_PHONE_VOLTE_SUPPORT
	ZyXEL_VoiceVoLTE_t* ZyXEL_VoiceVoLTE;
#endif
