...
typedef struct rdm_VoiceVolte_s {   // RDM_OID_VOICE_VOLTE 
	bool VolteEnable;
} rdm_VoiceVolte_t;
...
typedef struct rdm_AppSupportInfo_s {   // RDM_OID_APP_SUPPORT_INFO 
	char SupportAppInterfaceVersion[9];
	bool LanSideSupportHttps;
	char ProductSeries[17];
	bool AppStartupShowCellwanStatus;
} rdm_AppSupportInfo_t;

typedef struct rdm_MgmtSrv_s {   // RDM_OID_MGMT_SRV 
	bool EnableCWMP;
	int DelayReboot;
	char ScheduleReboot[32];
	char ScheduleFQCODEL[32];
	char URL[257];
...
typedef struct rdm_Cell_s {   // RDM_OID_CELL 
	bool RoamingEnabled;
	bool NetworkMonitorEnabled;
	bool X_ZYXEL_FqCodelEnabled;
	char X_ZYXEL_FQ_Mode_Type[17];
	char X_ZYXEL_Ping_ServerIp[257];
	uint32_t X_ZYXEL_Delay_Baseline;
	uint32_t X_ZYXEL_Latency_Diff;
	uint32_t X_ZYXEL_Latency_Limit;
	uint32_t X_ZYXEL_FQ_CODEL_UPLOAD;
	char RoamingStatus[17];
	uint32_t InterfaceNumberOfEntries;
	uint32_t AccessPointNumberOfEntries;
	bool X_ZYXEL_ProxyARP_Enabled;
} rdm_Cell_t;

typedef struct rdm_CellIntf_s {   // RDM_OID_CELL_INTF 
	bool Enable;
	char Status[17];
	char Alias[65];
	char Name[65];
	...
	char AvailableNetworks[1025];
	char NetworkRequested[65];
	char NetworkInUse[65];
	int RSSI;
	uint32_t UpstreamMaxBitRate;
	uint32_t DownstreamMaxBitRate;
	char X_ZYXEL_SupportedBands[1025];
	char X_ZYXEL_PreferredBands[1025];
	char X_ZYXEL_CurrentBand[1025];
	int X_ZYXEL_CellID;
	uint32_t X_ZYXEL_RFCN;
	int X_ZYXEL_RSRP;
	int X_ZYXEL_RSRQ;
	int X_ZYXEL_CPICHRSCP;
	int X_ZYXEL_CPICHEcNo;
	int X_ZYXEL_PhyCellID;
	int X_ZYXEL_UplinkBandwidth;
	int X_ZYXEL_DownlinkBandwidth;
	uint32_t X_ZYXEL_TAC;
	uint32_t X_ZYXEL_PrimaryScramblingCode;
	uint32_t X_ZYXEL_LAC;
	uint32_t X_ZYXEL_RAC;
	uint32_t X_ZYXEL_BSIC;
	int X_ZYXEL_SINR;
	int X_ZYXEL_CQI;
	int X_ZYXEL_MCS;
	int X_ZYXEL_RI;
	int X_ZYXEL_PMI;
	bool X_ZYXEL_HW_NAT_Enable;
	char X_ZYXEL_ModuleSoftwareVersion[129];
	char X_ZYXEL_ModuleSoftwareSubVersion[129];
} rdm_CellIntf_t;

typedef struct rdm_CellIntfUsim_s {   // RDM_OID_CELL_INTF_USIM 
	char Status[17];
	char IMSI[16];
	char ICCID[21];
	char MSISDN[16];
	...
	char PIN[5];
	char X_ZYXEL_PUK[9];
	char X_ZYXEL_NewPIN[5];
	bool X_ZYXEL_AutoUnlockPIN;
	bool X_ZYXEL_PIN_Protection;
	char X_ZYXEL_PIN_STATE[33];
	uint32_t X_ZYXEL_PIN_RemainingAttempts;
	uint32_t X_ZYXEL_PUK_RemainingAttempts;
} rdm_CellIntfUsim_t;

typedef struct rdm_CellIntfSt_s {   // RDM_OID_CELL_INTF_ST 
	uint64_t BytesSent;
	uint64_t BytesReceived;
	uint64_t PacketsSent;
	uint64_t PacketsReceived;
	...
	uint64_t UnicastPacketsSent;
	uint64_t UnicastPacketsReceived;
	uint64_t DiscardPacketsSent;
	uint64_t DiscardPacketsReceived;
	uint64_t MulticastPacketsSent;
	uint64_t MulticastPacketsReceived;
	uint64_t BroadcastPacketsSent;
	uint64_t BroadcastPacketsReceived;
	uint64_t UnknownProtoPacketsReceived;
} rdm_CellIntfSt_t;

typedef struct rdm_CellIntfZyBudgetControl_s {   // RDM_OID_CELL_INTF_ZY_BUDGET_CONTROL 
	bool Enable;
...
} rdm_CellIntfZyBudgetControl_t;

typedef struct rdm_CellIntfZyIpPassThru_s {   // RDM_OID_CELL_INTF_ZY_IP_PASS_THRU 
	bool Enable;
	char ConnectionMode[17];
	char MACAddress[18];
	bool X_ZYXEL_EthIfAsIppass;
	uint8_t ProxyARP_SubnetPrefix;
} rdm_CellIntfZyIpPassThru_t;

typedef struct rdm_CellIntfZyUiWaitSt_s {   // RDM_OID_CELL_INTF_ZY_UI_WAIT_ST 
	char WaitingStatus[33];
	char ApnWaitingStatus[33];
	char BandWaitingStatus[33];
	char PinWaitingStatus[33];
	char PlmnWaitingStatus[33];
	char SmsWaitingStatus[33];
} rdm_CellIntfZyUiWaitSt_t;

typedef struct rdm_CellIntfZyScc_s {   // RDM_OID_CELL_INTF_ZY_SCC 
	bool Enable;
	int PhysicalCellID;
	uint32_t RFCN;
	char Band[1025];
...
typedef struct rdm_CellIntfZyPciLock_s {   // RDM_OID_CELL_INTF_ZY_PCI_LOCK 
	bool Enable;
	char ConnectionMode[17];
	uint32_t NumberOfPCILocked;
} rdm_CellIntfZyPciLock_t;

typedef struct rdm_CellIntfZyPciLockedList_s {   // RDM_OID_CELL_INTF_ZY_PCI_LOCKED_LIST 
	int PhyCellID;
	uint32_t RFCN;
} rdm_CellIntfZyPciLockedList_t;

typedef struct rdm_CellIntfZyNbrCell_s {   // RDM_OID_CELL_INTF_ZY_NBR_CELL 
	bool Enable;
	char NeighbourType[33];
	char ConnectionMode[17];
	int PhyCellID;
	uint32_t RFCN;
	int RSSI;
	...
	int RSRQ;
	int SINR;
} rdm_CellIntfZyNbrCell_t;

typedef struct rdm_CellIntfZyNrNsa_s {   // RDM_OID_CELL_INTF_ZY_NR_NSA 
	bool Enable;
	char MCC[9];
	char MNC[9];
	int PhyCellID;
	...
	int RSRQ;
	int SINR;
} rdm_CellIntfZyNrNsa_t;

typedef struct rdm_CellIntfZySms_s {   // RDM_OID_CELL_INTF_ZY_SMS 
	bool Enable;
	bool InboxPurge;
	bool InboxRetrieve;
	bool OutboxRetrieve;
...
typedef struct rdm_CellIntfZySmsInbox_s {   // RDM_OID_CELL_INTF_ZY_SMS_INBOX 
	uint32_t Index;
	uint32_t State;
	char From[33];
	char TimeStamp[32];
	char PduContent[1025];
	char TextContent[1025];
} rdm_CellIntfZySmsInbox_t;

typedef struct rdm_CellIntfZySmsOutbox_s {   // RDM_OID_CELL_INTF_ZY_SMS_OUTBOX 
	uint32_t Format;
	char CharacterSet[9];
	char To[65];
	uint32_t PduLength;
	char TimeStamp[32];
	char Content[2049];
} rdm_CellIntfZySmsOutbox_t;

typedef struct rdm_CellIntfZySmsStorage_s {   // RDM_OID_CELL_INTF_ZY_SMS_STORAGE 
	char DefaultStorage[9];
	uint32_t UsedSpace;
	uint32_t TotalSpace;
} rdm_CellIntfZySmsStorage_t;

typedef struct rdm_CellAccessPoint_s {   // RDM_OID_CELL_ACCESS_POINT 
	bool Enable;
	char Alias[65];
	char APN[101];
	char Username[257];
	...
	bool X_ZYXEL_ManualAPN;
	bool X_ZYXEL_BridgeMode;
	char X_ZYXEL_AuthenticationType[17];
	char X_ZYXEL_PDP_Type[17];
	uint32_t X_ZYXEL_MTU;
	uint32_t X_ZYXEL_ConnectTime;
	uint32_t X_ZYXEL_ConnectDownTime;
} rdm_CellAccessPoint_t;

typedef struct rdm_CellZyGnssLoc_s {   // RDM_OID_CELL_ZY_GNSS_LOC 
	bool Enable;
	bool ScanOnBoot;
	...
	uint32_t HDOP;
	int Elevation;
	uint32_t PositioningMode;
	uint32_t CourseOverGround;
	uint32_t SpeedOverGround;
	char LastFixTime[32];
	uint32_t NumberOfSatellites;
} rdm_CellZyGnssLoc_t;

typedef struct rdm_CellIntfZyResetCm_s {   // RDM_OID_CELL_INTF_ZY_RESET_CM 
	bool Enable;
} rdm_CellIntfZyResetCm_t;
...
typedef struct rdm_IpDiagNutTcpDiag_s {   // RDM_OID_IP_DIAG_NUT_TCP_DIAG 
	char DiagnosticsState[29];
	char ServerIp[257];
	bool Receive;
	bool Transmit;
	...
	uint32_t Length;
	uint32_t Timeout;
	uint32_t NumberOfStream;
	bool OWD;
	bool Active;
	bool Clear;
	char Result[2049];
} rdm_IpDiagNutTcpDiag_t;
...
typedef struct rdm_Dhcpv6SrvPool_s {   // RDM_OID_DHCPV6_SRV_POOL 
	...
	bool X_ZYXEL_IAPDEnable;
	char X_ZYXEL_ClientDUID[131];
	char X_ZYXEL_IAPDPrefixes[49];
	char X_ZYXEL_IAPDIpAddress[49];
} rdm_Dhcpv6SrvPool_t;
...
typedef struct rdm_Dhcpv6Relay_s {   // RDM_OID_DHCPV6_RELAY 
	bool Enable;
	char Status[20];
	char Alias[65];
	uint32_t InterfaceSettingNumberOfEntries;
...
typedef struct rdm_Dhcpv6RelayIntfSet_s {   // RDM_OID_DHCPV6_RELAY_INTF_SET 
	bool Enable;
	char Status[20];
	char Alias[65];
	char Interface[257];
	char PreviousConfig[65];
	uint32_t DebugEnable;
	char WanInterface[257];
	char Dhcpv6ServerIpAddr[257];
} rdm_Dhcpv6RelayIntfSet_t;
...
typedef struct rdm_Mqtt_s {   // RDM_OID_MQTT 
	uint32_t ClientNumberOfEntries;
	char X_ZYXEL_BoundIfList[256];
} rdm_Mqtt_t;

typedef struct rdm_MqttCapability_s {   // RDM_OID_MQTT_CAPABILITY 
	char ProtocolVersionsSupported[33];
	char TransportProtocolSupported[33];
} rdm_MqttCapability_t;

typedef struct rdm_MqttClient_s {   // RDM_OID_MQTT_CLIENT 
	char Name[65];
	bool Enable;
	char Status[33];
	char ProtocolVersion[33];
	char BrokerAddress[257];
	uint32_t BrokerPort;
	char TransportProtocol[33];
	bool CleanSession;
	bool CleanStart;
	bool WillEnable;
	uint32_t WillQoS;
	...
	uint32_t ReceiveMaximum;
	uint32_t MaximumPacketSize;
	uint32_t TopicAliasMaximum;
	bool RequestResponseInfo;
	bool RequestProblemInfo;
	char AuthenticationMethod[257];
	char ClientID[24];
	uint32_t WillDelayInterval;
	uint32_t WillMessageExpiryInterval;
	char WillContentType[257];
	char WillResponseTopic[65536];
	char WillTopic[65536];
	char WillValue[65536];
	char Username[257];
	char Password[257];
	uint32_t PublishMessageExpiryInterval;
	uint32_t MessageRetryTime;
	uint32_t ConnectRetryTime;
	uint32_t ConnectRetryIntervalMultiplier;
	uint32_t ConnectRetryMaxInterval;
	char ResponseInformation[65536];
	int X_ZYXEL_QoS;
	char X_ZYXEL_Certificate[65536];
	char X_ZYXEL_CA_Certificate[65536];
} rdm_MqttClient_t;

typedef struct rdm_MqttClientPubConf_s {   // RDM_OID_MQTT_CLIENT_PUB_CONF 
	char Topic[513];
	uint32_t Interval;
	char Script[65536];
	char Output[33];
} rdm_MqttClientPubConf_t;

typedef struct rdm_MqttClientStats_s {   // RDM_OID_MQTT_CLIENT_STATS 
	char BrokerConnectionEstablished[32];
	char LastPublishMessageSent[32];
	char LastPublishMessageReceived[32];
	uint32_t PublishSent;
	uint32_t PublishReceived;
	uint32_t MQTTMessagesSent;
	uint32_t MQTTMessagesReceived;
	uint32_t ConnectionErrors;
	uint32_t PublishErrors;
} rdm_MqttClientStats_t;
...
typedef struct rdm_RemoMgmtIpPassThru_s {   // RDM_OID_REMO_MGMT_IP_PASS_THRU 
	uint32_t ServiceNumberOfEntries;
	char BoundWANInterfaceList[257];
} rdm_RemoMgmtIpPassThru_t;

typedef struct rdm_RemoSrvIpPassThru_s {   // RDM_OID_REMO_SRV_IP_PASS_THRU 
	char Name[33];
	bool Enable;
	int Protocol;
	int Port;
	...
	char BoundInterfaceList[129];
	bool TrustAll;
} rdm_RemoSrvIpPassThru_t;

typedef struct rdm_RemoSrvTrustDomainIpPassThru_s {   // RDM_OID_REMO_SRV_TRUST_DOMAIN_IP_PASS_THRU 
	bool Enable;
	char IPAddress[49];
	char SubnetMask[16];
} rdm_RemoSrvTrustDomainIpPassThru_t;

typedef struct rdm_SpRemoSrvIpPassThru_s {   // RDM_OID_SP_REMO_SRV_IP_PASS_THRU 
	char Name[33];
	bool Enable;
	int Protocol;
	int Port;
	...
	char BoundInterfaceList[129];
	bool TrustAll;
} rdm_SpRemoSrvIpPassThru_t;

typedef struct rdm_SpRemoSrvTrustDomainIpPassThru_s {   // RDM_OID_SP_REMO_SRV_TRUST_DOMAIN_IP_PASS_THRU 
	bool Enable;
	char IPAddress[49];
	char SubnetMask[16];
	char WebDoaminName[65];
} rdm_SpRemoSrvTrustDomainIpPassThru_t;

typedef struct rdm_RemoMgmtTrustDomainIpPassThru_s {   // RDM_OID_REMO_MGMT_TRUST_DOMAIN_IP_PASS_THRU 
	bool Enable;
	char IPAddress[49];
	char SubnetMask[16];
} rdm_RemoMgmtTrustDomainIpPassThru_t;

typedef struct rdm_SpTrustDomainIpPassThru_s {   // RDM_OID_SP_TRUST_DOMAIN_IP_PASS_THRU 
	bool Enable;
	char IPAddress[49];
	char SubnetMask[16];
	char WebDomainName[65];
} rdm_SpTrustDomainIpPassThru_t;
...
typedef struct rdm_ZyWWANCellularCpeWanBackupConfig_s {   // RDM_OID_ZY_W_W_A_N_CELLULAR_CPE_WAN_BACKUP_CONFIG 
	bool WanBackupEnable;
	char ETHLinkInterface[257];
	char CellLinkInterface[257];
	char ETHIPInterface[257];
	char CellIPInterface[257];
	char PrimaryWANLinkType[65];
	char ConnectionCheckSite1_Name[257];
	char ConnectionCheckSite1_IP[257];
	char ConnectionCheckSite2_Name[257];
	char ConnectionCheckSite2_IP[257];
	char ConnectionCheckSite3_Name[257];
	char ConnectionCheckSite3_IP[257];
	char ConnectionCheckSiteUser[257];
	uint32_t ConnectionCheckSiteID;
	uint32_t Interval;
	uint32_t FailLimit;
} rdm_ZyWWANCellularCpeWanBackupConfig_t;
...
typedef struct rdm_OnlineFWUpgrade_s {   // RDM_OID_ONLINE_F_W_UPGRADE 
	...
	char FWURL[1025];
	char FWInfoFileName[65];
	bool FWUpdateNotify;
} rdm_OnlineFWUpgrade_t;

typedef struct rdm_OnlineModuleUpgrade_s {   // RDM_OID_ONLINE_MODULE_UPGRADE 
	bool Enable;
	char SystemModelName[65];
	char ModuleInfoURL[1025];
	char ModuleFileName[65];
	char ModuleVersion[65];
	char ModuleReleaseDate[32];
	char ModuleSize[33];
	uint32_t HttpSevrPort;
	char ModuleURL[1025];
	char ModuleInfoFileName[65];
} rdm_OnlineModuleUpgrade_t;
