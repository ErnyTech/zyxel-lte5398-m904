...
#define MRD_SIZE                    0x200+NUM_OF_CERT_BYTES+NUM_OF_KEY_BYTES+NUM_OF_PASSWD_TOTAL_BYTES
#else
#define NUM_OF_PASSWD_BYTES			0x0
#define MRD_SIZE                    0x200+NUM_OF_CERT_BYTES+NUM_OF_KEY_BYTES+NUM_OF_PASSWD_BYTES
#endif
