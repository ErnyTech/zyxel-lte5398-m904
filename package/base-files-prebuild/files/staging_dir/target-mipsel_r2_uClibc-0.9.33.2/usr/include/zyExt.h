...
extern tr98Parameter_t para_Ssh[];
extern tr98Parameter_t para_SshPubKey[];
#endif
...
#ifdef ZYXEL_SSH_PUBLIC_KEY_MGMT
extern zcfgRet_t zyExtSshObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyExtSshObjNotify(char *, char *, struct json_object *, int, struct json_object **);
extern int zyExtSshObjAttrGet(char *, int, char *);
extern zcfgRet_t zyExtSshObjAttrSet(char *, int, char *, int , struct json_object *);

extern zcfgRet_t zyExtSshPubKeyObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyExtSshPubKeyObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
extern zcfgRet_t zyExtSshPubKeyObjAdd(char *tr98FullPathName, int *idx);
extern zcfgRet_t zyExtSshPubKeyObjDel(char *tr98FullPathName);
extern zcfgRet_t zyExtSshPubKeyObjNotify(char *, char *, struct json_object *, int, struct json_object **);
extern int zyExtSshPubKeyObjAttrGet(char *, int, char *);
extern zcfgRet_t zyExtSshPubKeyObjAttrSet(char *, int, char *, int , struct json_object *);
#endif
