...
typedef enum {
    ...
    TIC_GET_STATUS_DRIVER_ATTACH      = 38,
    TIC_CONTROL_UNKNOWN_CODE          = 39  /* Last Entry*/
} TIC_ControlCode;
...
typedef enum {
    ...
    TIC_GET_STATUS_HOOK_HANDSET         = 36,
    TIC_GET_STATUS_NUM_INFC_FXS         = 37,
    TIC_GET_STATUS_NUM_INFC_FXO         = 38,
    TIC_GET_STATUS_NUM_INFC_AUDIO       = 39,
    TIC_GET_STATUS_UNKNOWN_CODE         = 40  /* Last Entry */
} TIC_GetStatusCode;
...
/*
 * Pulse Digit Generate Object
 */
typedef struct {
    vint   strCurrent;
    vint   pulseReady;
    uint32 interDigitTime;
    uint32 pauseTime;
    uint32 pulseDrop;
    uint32 pulseState;
    uint32 pulseStatus;
...
/*
 * Exchange bytes with the TIC physical interface
 */
