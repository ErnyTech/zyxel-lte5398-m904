...
#if defined (PROVIDER_VERIZON)
#define OSAL_MSG_SIZE_MAX         (6144)
#elif defined (PROVIDER_PANASONIC)
#define OSAL_MSG_SIZE_MAX         (6084)
#else
#define OSAL_MSG_SIZE_MAX         (5120)
#endif
...
OSAL_Status OSAL_msgQGrpRemoveQ(
    OSAL_MsgQGrpId *g_ptr,
    OSAL_MsgQId     qId);
