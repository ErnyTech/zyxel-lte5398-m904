 ...
 *
 * $D2Tech$ $Rev: 48551 $ $Date: 2019-12-31 17:19:45 +0800 (Tue, 31 Dec 2019) $
 *
 */
...
#define VTSP_DETECT_TEL_EVENT           (1 << 8)

#define VTSP_TONE_BREAK_MIX         (1 << 0)
#define VTSP_TONE_MIX               (1 << 1)
...
typedef enum {
    ...
    VTSP_CODER_CN              =  2,
    VTSP_CODER_G729            =  3,
    VTSP_CODER_G726_32K        =  4,
    VTSP_CODER_ILBC_20MS       =  5,
    VTSP_CODER_ILBC_30MS       =  6,
    VTSP_CODER_G723_30MS       =  7,
    VTSP_CODER_DTMF            =  8,
    VTSP_CODER_T38             =  9,
    VTSP_CODER_16K_MU          = 10,
    VTSP_CODER_G722            = 11,
    VTSP_CODER_G722P1_20MS     = 12,
    VTSP_CODER_TONE            = 13,
    VTSP_CODER_GAMRNB_20MS_OA  = 14, /* Octet-Align format. */
    VTSP_CODER_GAMRNB_20MS_BE  = 15, /* Bandwidth-Efficient format. */
    VTSP_CODER_GAMRWB_20MS_OA  = 16, /* Octet-Align format. */
    VTSP_CODER_GAMRWB_20MS_BE  = 17, /* Bandwidth-Efficient format. */
    VTSP_CODER_G711P1U         = 18,
    VTSP_CODER_G711P1A         = 19,
    VTSP_CODER_SILK_20MS_8K    = 20,
    VTSP_CODER_SILK_20MS_16K   = 21,
    VTSP_CODER_SILK_20MS_24K   = 22,
    VTSP_CODER_G726_16K        = 23,
    VTSP_CODER_G726_24K        = 24,
    VTSP_CODER_G726_40K        = 25,
    VTSP_CODER_TEL_EVENT       = 26,
    /* Add new coder above this comment */
    VTSP_CODER_LAST,
    VTSP_ENCODER_NUM           = VTSP_CODER_LAST,
    VTSP_DECODER_NUM           = VTSP_ENCODER_NUM,
    VTSP_CODER_NUM             = VTSP_ENCODER_NUM,
} VTSP_coderType;
...
#define VTSP_MASK_CODER_TEL_EVENT     (1 << VTSP_CODER_TEL_EVENT)
...
typedef enum {
    ...
    VTSP_TEMPL_CONTROL_CID_DTMF_SC      = 5
...
typedef enum { 
    ...
    VTSP_TEMPL_CONTROL_RTP_DEFAULT_TOS = 4,
...
typedef enum { 
    ...
    VTSP_EVENT_MSG_CODE_TEL_EVENT               = 33
} VTSP_EventMsgCodes;
...
typedef enum {
    ...
    VTSP_TEMPL_CID_FORMAT_ETSI_DTAS = 6,
    VTSP_TEMPL_CID_FORMAT_ETSI_RPAS = 7,
    VTSP_TEMPL_CID_FORMAT_ETSI_LR   = 8,
    VTSP_TEMPL_CID_FORMAT_DATA_ETSI = 9,
    VTSP_TEMPL_CID_FORMAT_ETSI_DTDR = 10,       /* Data Transmission During Ringing */
    VTSP_TEMPL_CID_FORMAT_US_OSI    = 11,       /* On-Hook Data Transmission Without Power Ringing */
} VTSP_TemplateCidFormat;

/*
 * Start Code of the DTMF CID
 */
typedef enum {
    VTSP_TEMPL_CID_DTMF_SC_A = 0,
    VTSP_TEMPL_CID_DTMF_SC_D = 1,
} VTSP_TemplateCidDtmfSc;
...
typedef enum {
    ...
    VTSP_TEMPL_CONTROL_DEBUG_LOG_SET_PRIORITY  = 2,
    VTSP_TEMPL_CONTROL_DEBUG_LOG_SET_DEST_ADDR = 3,
