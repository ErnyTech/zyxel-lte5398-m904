 ...
 *
 * $D2Tech$ $Rev: 44823 $ $Date: 2018-12-27 16:04:08 +0800 (Thu, 27 Dec 2018) $
 */
...
#endif
/* VTSP log Macros. */
#define RTP_LOG_MSG_CRIT(fmt, args...) \
        OSAL_LOG_MSG_CRIT(OSAL_LOG_MODULE_VTSP, fmt, ##args)
#define RTP_LOG_MSG_ERR(fmt, args...) \
        OSAL_LOG_MSG_ERR(OSAL_LOG_MODULE_VTSP, fmt, ##args)
#define RTP_LOG_MSG_WARN(fmt, args...) \
        OSAL_LOG_MSG_WARN(OSAL_LOG_MODULE_VTSP, fmt, ##args)
#define RTP_LOG_MSG_INFO(fmt, args...) \
        OSAL_LOG_MSG_INFO(OSAL_LOG_MODULE_VTSP, fmt, ##args)
#define RTP_LOG_MSG_DEBUG(fmt, args...) \
        OSAL_LOG_MSG_DEBUG(OSAL_LOG_MODULE_VTSP, fmt, ##args)
