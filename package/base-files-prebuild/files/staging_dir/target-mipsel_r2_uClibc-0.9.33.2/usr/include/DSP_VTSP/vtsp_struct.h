 ...
 *
 * $D2Tech$ $Rev: 47515 $ $Date: 2019-10-08 16:10:40 +0800 (Tue, 08 Oct 2019) $
 *
 */
...
typedef struct {
    ...
    VTSP_TemplateCidDtmfSc  dtmfStartCode;
    uvint                   mdidTimeout; 
    vint                    fskPower;
    vint                    sasPower;
    vint                    casPower;
...
typedef struct {
    ...
    OSAL_LogModule            logModule;
    OSAL_LogPriority          logPriority;
} VTSP_DebugTemplate;
...
#if defined(PROVIDER_PANASONIC)    
    vint            rtpDummyPktInterval;
#endif
} VTSP_Stream;
