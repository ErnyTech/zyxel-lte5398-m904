...
#define NVRAM_SHOW_CERT_CMD				"/usr/bin/nvram show cert > /tmp/.cert-startup; rm /tmp/.nvramcache" 
...
//#define NVRAM_CERT_INIT_CMD                  "/usr/bin/nvram show cert > /tmp/.cert-startup"
#define NVRAM_CERT_SETRO_CMD                 "/usr/bin/nvram setro cert %s \"%s\""
//#define NVRAM_CERT_SHOW_CMD                  "/usr/bin/nvram show cert"
...
#define CERT_STARTUP_FILE			"/tmp/.cert-startup"
...
#define UBOOT_EXTRA_ENV_LOCAL_CERTIFICATE 		"LocalCertificate"
#define UBOOT_EXTRA_ENV_PRIVATE_KEY 		"PrivateKey"
