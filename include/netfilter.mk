...
# kernel only
$(eval $(if $(NF_KMOD),$(call nf_add,IPT_NAT,CONFIG_NF_NAT, $(P_XT)nf_nat $(P_V4)nf_nat_ipv4 $(P_XT)xt_nat $(P_V4)iptable_nat $(P_V4)nf_nat_pt, ge 3.7.0),))
...
$(eval $(call nf_add,EBTABLES,CONFIG_BRIDGE_EBT_AUTOMAP, $(P_EBT)ebt_AUTOMAP))
$(eval $(call nf_add,EBTABLES,CONFIG_BRIDGE_EBT_POLICER, $(P_EBT)ebt_policer))
$(eval $(call nf_add,EBTABLES,CONFIG_BRIDGE_EBT_TC, $(P_EBT)ebt_tc))
$(eval $(call nf_add,EBTABLES,CONFIG_BRIDGE_EBT_FTOS, $(P_EBT)ebt_ftos))
