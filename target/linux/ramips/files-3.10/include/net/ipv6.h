...
#ifdef CONFIG_ZYXEL
	/*ZYXEL add : wwan interface always be host interface and return accept_ra */
	/*Add eth2.2 interface always be host interface and return accept_ra for indoor*/
	if(!strncmp(idev->dev->name, "wwan", 4) || !strncmp(idev->dev->name, "eth2.2", 6))
	return idev->cnf.accept_ra ? true : false ;
	else
#endif
