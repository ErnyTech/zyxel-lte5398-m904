...
/* guest_wlan_id = mark[11:11] */
#define SKBMARK_GWL_ID_S         11
...
/* VID_ACTION = mark[8:6], Change the bits used for Qos vlan operation. Original bits and WMM overlap */
#define SKBMARK_VID_ACTION_S       6
#define SKBMARK_VID_ACTION_M       (0x0F << SKBMARK_VID_ACTION_S)
...
/* POLICER = mark[10:9], Change the bits used for Qos policer */
#define SKBMARK_POLICER_S       9
