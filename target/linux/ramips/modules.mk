...
define KernelPackage/hw_nat
  ...
  DEPENDS:=@TARGET_ramips_mt7620||@TARGET_ramips_mt7621||@TARGET_mediatek_mt7623_emmc||@TARGET_mediatek_mt7623_mtd||@TARGET_ramips_lte7240||@TARGET_ramips_lte7461||@TARGET_ramips_lte7480||@TARGET_ramips_lte7481||@TARGET_ramips_lte7485||@TARGET_ramips_lte7490||@TARGET_ramips_nr7101||@TARGET_ramips_nr7201||@TARGET_ramips_lte3301p||@TARGET_ramips_lte5388||@TARGET_ramips_lte5389
  ifeq ($(CONFIG_RA_NAT_HW_IPV6_ZYXEL),y)
  FILES:=$(LINUX_DIR)/net/nat_20201028/hw_nat/hw_nat.ko
  else
...
#Work around to openwrt kernel module limited options:
	cp $(LINUX_DIR)/net/netfilter/*.ko $(1)/lib/modules/$(if $(findstring y,$(CONFIG_TARGET_mediatek)),3.10.20,3.10.14)
	cp $(LINUX_DIR)/net/ipv4/netfilter/*.ko $(1)/lib/modules/$(if $(findstring y,$(CONFIG_TARGET_mediatek)),3.10.20,3.10.14)
	cp $(LINUX_DIR)/net/ipv6/netfilter/*.ko $(1)/lib/modules/$(if $(findstring y,$(CONFIG_TARGET_mediatek)),3.10.20,3.10.14)
endef
...
define KernelPackage/mtk-gdma
  ...
  SUBMENU:=Drivers
  TITLE:=GDMA Driver
  DEPENDS:=@TARGET_ramips_mt7621||@TARGET_ramips_lte7240||@TARGET_ramips_lte7461||@TARGET_ramips_lte7480||@TARGET_ramips_lte7481||@TARGET_ramips_lte7485||@TARGET_ramips_lte7490||@TARGET_ramips_nr7101||@TARGET_ramips_lte5388_s905
...
define KernelPackage/mtk-pcm
  ...
  DEPENDS:=@TARGET_ramips_mt7621||@TARGET_ramips_lte7240||@TARGET_ramips_lte7461||@TARGET_ramips_lte7480||@TARGET_ramips_lte7481||@TARGET_ramips_lte7485||@TARGET_ramips_lte7490||@TARGET_ramips_nr7101||@TARGET_ramips_lte5388_s905 +kmod-mtk-gdma
...
define KernelPackage/mtk-i2s
  ...
  SUBMENU:=Drivers
  TITLE:=I2S Driver
  DEPENDS:=@TARGET_ramips_mt7621||@TARGET_ramips_lte7240||@TARGET_ramips_lte7461||@TARGET_ramips_lte7480||@TARGET_ramips_lte7481||@TARGET_ramips_lte7485||@TARGET_ramips_lte7490||@TARGET_ramips_nr7101||@TARGET_ramips_lte5388_s905 +kmod-mtk-gdma +kmod-mtk-i2c
...
define KernelPackage/hw_ipsec_mt7621
  CATEGORY:=MTK Properties
  SUBMENU:=Drivers
  TITLE:=MTK Hardware IPSEC for MT7621 only
  KCONFIG:=CONFIG_HW_IPSEC=y CONFIG_RALINK_HWCRYPTO=m
  DEPENDS:=@TARGET_ramips_mt7621||@TARGET_ramips_lte7240||@TARGET_ramips_lte7461||@TARGET_ramips_lte7480||@TARGET_ramips_lte7481||@TARGET_ramips_lte7485||@TARGET_ramips_lte7490||@TARGET_ramips_nr7101||@TARGET_ramips_lte5388_s905
  FILES:=$(LINUX_DIR)/drivers/net/cryptoDriver/crypto_k.ko
  AUTOLOAD:=$(call AutoProbe,hw_ipsec_mt7621)
endef

define KernelPackage/hw_ipsec_mt7621/install
	$(INSTALL_DIR) $(1)/lib/modules/ralink/
	mv $(1)/lib/modules/$(if $(findstring y,$(CONFIG_TARGET_mediatek)),3.10.20,3.10.14)/crypto_k.ko $(1)/lib/modules/ralink/
endef

$(eval $(call KernelPackage,hw_ipsec_mt7621))
